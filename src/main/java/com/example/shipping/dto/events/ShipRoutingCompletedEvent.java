...
@NoArgsConstructor
@Data
public class ShipRoutingCompletedEvent extends BaseEvent {
	private ShipDTO shipDTO;
	private static String EVENT_NAME = "ShipRoutingCompletedEvent";
	public ShipRoutingCompletedEvent(ShipDTO shipDTO) {
		this(shipDTO, null);
	}

	public ShipRoutingCompletedEvent(ShipDTO shipDTO, Map headerMap) {
		super(EVENT_NAME);
