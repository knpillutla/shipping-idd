...
@NoArgsConstructor
@Data
public class ShipCreatedEvent extends BaseEvent {
	private ShipDTO shipDTO;
	private static String EVENT_NAME = "ShipCreatedEvent";
	public ShipCreatedEvent(ShipDTO shipDTO) {
		this(shipDTO, null);
	}

	public ShipCreatedEvent(ShipDTO shipDTO, Map headerMap) {
		super(EVENT_NAME);
